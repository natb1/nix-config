...
| iPhone | **Jellyfin** (App Store, free); Infuse (paid) is the more polished alternative and reads Jellyfin or the share | Kavita's web reader, or **Readest** (OPDS for downloads, KOReader sync pointed at Kavita for positions) |
